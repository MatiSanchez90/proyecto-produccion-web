...
<body>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            ...
            <li class="page-item">
                <a class="page-link" href="consulta.php?pag=<?php echo $paginacion['anterior'] ?>">
                    <?php echo $paginacion['anterior'] ?> </a>
            </li>
            <?php endif ?>
            ...
            <li class="page-item">
                <a class="page-link" href="?pag=<?php echo $paginacion['siguiente'] ?>">
                    <?php echo $paginacion['siguiente'] ?> </a>
            </li>
            <li class="page-item">
